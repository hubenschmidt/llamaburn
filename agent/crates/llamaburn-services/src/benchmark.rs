...
impl BenchmarkService {
    ...
    /// Returns a receiver for benchmark events and a handle to cancel the benchmark
    ...
    pub fn run_streaming(
        ...
        thread::spawn(move || {
            ...
            rt.block_on(async {
                ...
                // Forward events from tokio channel to std channel
